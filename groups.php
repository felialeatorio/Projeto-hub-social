                ...
                <nav id='navbar-main' class='navbar navbar-expand-lg shadow-sm sticky-top'>
                    <div class='w-100 justify-content-md-center'>
                        <ul class='nav navbar-nav enable-mobile px-2'>
                            ...
                            <li class='nav-item'>
                                <a href='messages.php' class='nav-link nav-icon nav-links message-drop drop-w-tooltip' data-placement='bottom' data-title='Mensgens'>
                                    <img src='assets/images/icons/navbar/message.png' class='message-dropdown f-nav-icon' alt='navbar icon'>
                                </a>
                            </li>
                        </ul>
                        <ul class='navbar-nav mr-5 flex-row' id='main_menu'>
                            <a class='navbar-brand nav-item mr-lg-5' href='index.php'><img src='assets/images/logo-64x64.png' width='40' height='40' class='mr-3' alt='Logo'></a>
                            ...
                            <li class='nav-item s-nav dropdown notification'>
                                ...
                                <ul class='dropdown-menu notify-drop dropdown-menu-right nav-drop shadow-sm'>
                                    <div class='notify-drop-title'>
                                        <div class='row'>
                                            <div class='col-md-6 col-sm-6 col-xs-6 fs-8'>Notificações <span class='badge badge-pill badge-primary ml-2'>3</span></div>
                                            <div class='col-md-6 col-sm-6 col-xs-6 text-right'>
                                                <a href='#' class='notify-right-icon'>
                                                    Mark All as Read
                                                </a>
                        ...
                        <div class='card newsfeed-user-card h-100'>
                            <ul class='list-group list-group-flush newsfeed-left-sidebar'>
                                ...
                                <li class='list-group-item d-flex justify-content-between align-items-center'>
                                    <a href='index.php' class='sidebar-item'><img src='assets/images/icons/left-sidebar/newsfeed.png' alt='newsfeed'> Feed de Notícias</a>
                                ...
                                <li class='list-group-item d-flex justify-content-between align-items-center'>
                                    <a href='saved.php' class='sidebar-item'><img src='assets/images/icons/left-sidebar/saved.png' alt='saved'> Salvos</a>
                                    <span class='badge badge-primary badge-pill'>8</span>
                                </li>
                                <li class='list-group-item d-flex justify-content-between align-items-center'>
                                    <a href='find-friends.php' class='sidebar-item'><img src='assets/images/icons/left-sidebar/find-friends.png' alt='find-friends'> Achar Amigos</a>
                                    <span class='badge badge-primary badge-pill'><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class='list-group-item d-flex justify-content-between align-items-center'>
                                    <a href='matches.php' class='sidebar-item'><img src='assets/images/icons/left-sidebar/matches.png' alt='matches'> Matches</a>
                                    <span class='badge badge-primary badge-pill'><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class='list-group-item d-flex justify-content-between align-items-center'>
                    ...
                    <div class='col-md-10 second-section' id='page-content-wrapper'>
                        <div class='mb-3'>
                            <div class='btn-group d-flex top-links-fg'>
                                <a href='index.php' class='btn btn-quick-links mr-3 ql-active'>
                                    ...
                                    <span class='fs-8'>Seus Grupos</span>
                                </a>
                        ...
                        <div class='jumbotron groups-banner'>
                            <div class='container group-banner-content'>
                                <h1 class='jumbotron-heading mt-auto'><img src='assets/images/icons/theme/group-white.png' class='mr-3' alt='Welcome to groups'> Grupos</h1>
                        ...
                        <div class='groups bg-white py-3 px-4 shadow-sm'>
                            <div class='card-head d-flex justify-content-between'>
                                <h5 class='mb-4'>Grupos Sugeridos</h5>
                                <a href='#' class='btn btn-link'>Veja tudo</a>
                            </div>
                            <div class='row'>
                                <div class='col-md-3 col-sm-6'>
                                    <div class='card group-card shadow-sm'>
                                        ...
                                        <div class='card-body'>
                                            ...
                                            <a href='#' class='btn btn-quick-link join-group-btn border w-100'>Entre</a>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-3 col-sm-6'>
                        ...
                        <div class='groups py-3 px-4 mt-3'>
                            <div class='card-head d-flex justify-content-between'>
                                <h5 class='mb-4'>Grupos de Amigos</h5>
                                ...
                                <div class='col-md-6 col-sm-6'>
                                    <div class='card group-card bg-transparent group-card-inline mb-3'>
                                        <div class='row no-gutters  d-flex align-items-center'>
                                            ...
                                            <div class='col-md-2'>
                                                <a href='#' class='btn btn-quick-link bg-white'>Entre</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
