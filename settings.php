                            ...
                            <div class="dropdown-menu nav-drop">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="index.php" class="sidebar-item"><i class='bx bx-news text-primary'></i> News Feed</a>
                                        <a href="#" class="newsfeedListicon"><i class='bx bx-dots-horizontal-rounded'></i></a>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="messages.php" class="sidebar-item"><i class='bx bx-envelope text-primary'></i> Messages</a>
                                        <span class="badge badge-primary badge-pill">2</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="groups.php" class="sidebar-item"><i class='bx bx-group text-primary'></i> Groups</a>
                                        <span class="badge badge-primary badge-pill">17</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="events.php" class="sidebar-item"><i class='bx bx-calendar text-primary'></i> Events</a>
                                        <span class="badge badge-primary badge-pill">3</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="saved.php" class="sidebar-item"><i class='bx bx-bookmarks text-primary'></i> Saved</a>
